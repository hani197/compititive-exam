...
function RequestsPage() {
  ...
  const roleStyle = {
    ...
    coaching_centre: { bg: '#dcfce7', color: '#166534' },
  };
  const statusStyle = {
              ...
              {requests.map(r => {
                ...
                return (
                  <TableRow key={r.id}>
                    ...
                    <TableCell>
                      <Chip 
                        label={r.role === 'coaching_centre' ? 'Admin' : r.role || 'student'} 
                        size="small" 
                        sx={{ bgcolor: rs.bg, color: rs.color, fontWeight: 700, textTransform: 'capitalize' }} 
                      />
                    </TableCell>
        ...
        <DialogContent sx={{ pt: 3 }}>
          ...
          <FormControl fullWidth margin="normal">
            ...
            <Select value={form.role} label="Role" onChange={e => setForm({ ...form, role: e.target.value })}>
              ...
              <MenuItem value="coaching_centre">Admin (Coaching Centre)</MenuItem>
            </Select>
          </FormControl>
